...
class Homepage extends Component {
  ...
  static navigationOptions = {
    ...
    // headerTintColor: "#fff",
    // headerRight: (
    //     <TouchableOpacity onPress={ this.toggleSearchBox } style={{ paddingHorizontal: 10 }}>
  ...
  render() {
    ...
    console.log("OBIDF ", this.state.mostRecent)
    if (showSearch) {
      searchbar = <SearchBar placeholder="Search..." onChangeText={this.updateSearch} value={search} platform="android" />
    }
